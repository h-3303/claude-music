...
"""claude-music library MCP server (stdio).
...
mcp = MCPServer(
    name="library",
    instructions=(
        "claude-music: import playlist files, canonicalise them against MusicBrainz, find which tracks are already "
...
async def import_playlist_file(
    ...
    written as JSPF under the plugin data dir and gets a playlist_id. Spotify exports have no durations;
