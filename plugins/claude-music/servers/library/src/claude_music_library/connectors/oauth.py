...
_PAGE = """<!doctype html><meta charset="utf-8"><title>claude-music</title>
    ...
    def __init__(self, redirect_uri: str, expected_state: str, lifetime_s: float = 600.0):
        ...
        class Handler(http.server.BaseHTTPRequestHandler):
            ...
            def do_GET(self):
                ...
                self._reply(200, "Connected", "claude-music received the authorisation code.")
        ...
        self._thread = threading.Thread(target=self._serve, name="claude-music-oauth", daemon=True)
        self._thread.start()
